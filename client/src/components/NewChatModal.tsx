          ...
          {tab === 'users' ? (
            <>
              ...
              <div className="max-h-64 overflow-y-auto space-y-1">
                {users.map(u => (
                  <button key={u.id} onClick={() => startPrivate(u.id)} className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-surface-tertiary dark:hover:bg-dark-tertiary transition-colors">
