...
export default function ChatWindow({ chatId, onBack, showMobileList }: Props) {
  ...
  if (!chatId || !chat) return (
    <div className={`flex-1 flex items-center justify-center ${showMobileList ? 'hidden md:flex' : 'flex'}`}>
      <div className="text-center">
        <div className="w-16 h-16 bg-tertiary dark:bg-dark-tertiary rounded-2xl flex items-center justify-center mx-auto mb-4">
  ...
  return (
    <div className={`flex-1 flex flex-col ${showMobileList ? 'hidden md:flex' : 'flex'}`}>
      <div className="h-14 flex items-center gap-3 px-4 border-b border-tertiary dark:border-dark-tertiary shrink-0">
